...
interface CommonOptions {
  sourcemap?: boolean | 'inline' | 'external' | 'linked' | 'none';
  format?: Format;
  globalName?: string;
...
// Works in node: yes
// Works in browser: no
export  function build(options: BuildOptions & { write: false }): Promise<BuildResult & { outputFiles: OutputFile[] }>;
export  function build(options: BuildOptions & { incremental: true }): Promise<BuildIncremental>;
...
// Works in node: yes
// Works in browser: no
export  function buildSync(options: BuildOptions & { write: false }): BuildResult & { outputFiles: OutputFile[] };
