...
func system(ctx *js.Context, global js.Value) {
	sys := ctx.Object()
	global.Set("system", sys)

	// memory(): { Alloc, TotalAlloc, Sys, NumGC, HeapAlloc, HeapSys, ... }
	sys.Set("memory", func(_ js.Arguments) interface{} {
	...
	// goroutines(): number
	sys.Set("goroutines", func(_ js.Arguments) interface{} {
		return runtime.NumGoroutine()
	})

	// gc(): trigger a GC
	sys.Set("gc", func(_ js.Arguments) interface{} {
		runtime.GC()
		return nil
	})
