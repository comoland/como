// import * as all from 'bufferxxx'
// import { byteLengthUtf8  } from 'buffer.go';

// console.log(byteLengthUtf8("DDDDD"))
/* Blob.js
...
console.log(textBlob.type); // Output: text/plain

const bufferData = Buffer.from('Binary data example');
const bufferBlob = new Blob([bufferData], { type: 'application/octet-stream' });
console.log(bufferBlob.size); // Output: 19

const mixedBlob = new Blob(['Part 1, ', Buffer.from('Part 2')], { type: 'text/plain' });
console.log(mixedBlob.size); // Output: 13

// async function writeBlobToFile(blob, filePath) {
//     await Bun.write(filePath, blob);
//     console.log(`Blob written to ${filePath}`);
//   }

//   writeBlobToFile(textBlob, './output.txt');

//   // Reading a file as a Blob (BunFile is a Blob)
