...
func registerCrypto(ctx *js.Context) {

	mod := ctx.NewModule("web:crypto.go")

	// Create crypto backend
	backend := NewCryptoBackend(ctx)

	// Generate key function
	mod.Export("generateKey", func(args js.Arguments) interface{} {
		if args.Len() < 3 {
	...
	// Sign function
	mod.Export("sign", func(args js.Arguments) interface{} {
		if args.Len() < 3 {
	...
	// Verify function
	mod.Export("verify", func(args js.Arguments) interface{} {
		if args.Len() < 4 {
	...
	// Encrypt function
	mod.Export("encrypt", func(args js.Arguments) interface{} {
		if args.Len() < 4 {
	...
	// Decrypt function
	mod.Export("decrypt", func(args js.Arguments) interface{} {
		if args.Len() < 4 {
	...
	// Digest function
	mod.Export("digest", func(args js.Arguments) interface{} {
		if args.Len() < 2 {
	...
	mod.Export("getRandomValues", func(args js.Arguments) interface{} {
		if args.Len() < 1 {
