import * as ops from 'web:crypto.go'

const getRandomValues = array => {
    const m = new Uint8Array(ops.getRandomValues(array));
    array.set(m);
    return array;
};
...
class SubtleCrypto {
    constructor() {
        this._generateKey = ops.generateKey;
        this._sign = ops.sign;
        this._verify = ops.verify;
        this._encrypt = ops.encrypt;
        this._decrypt = ops.decrypt;
        this._digest = ops.digest;
    }
