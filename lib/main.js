...
globalThis.Como = globalThis.Como ?? {};
Object.assign(globalThis.Como, como);
...
const { TextEncoder, TextDecoder } = await import("web:textencoder");
...
const { Headers } = await import("web:headers");
globalThis.Headers = Headers;

// Request implementation
const { Request } = await import("web:request");
globalThis.Request = Request;

// Response implementation
const { Response } = await import("web:response");
...
const { Blob, File } = await import("web:blob");
globalThis.Blob = Blob;
globalThis.File = File;

// Web URL
const { URL, URLSearchParams } = await import("web:url");
globalThis.URL = URL;
