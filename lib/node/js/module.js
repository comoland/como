...
import * as ops from 'node:module.go';
...
class ModuleLoader {
    ...
    createRequire(filename, parentModule = null) {
        ...
        function require(id) {
            ...
            if (globalThis["modules_exports"] && globalThis["modules_exports"][id]) {
                return globalThis["modules_exports"][id]
            }
    ...
    _loadMJS(filepath, module) {
        module.exports = ops.load_mjs_module(filepath);
    }
    ...
    _isCoreModule(id) {
        return id && ops.is_core_module(id);
    }
