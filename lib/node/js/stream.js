...
__reExport(stdin_exports, __toESM(require_readable_browser()));
var x = require_readable_browser();
var stdin_default = x;
var Transform = x.Transform;
var Stream = x.Stream;
var Readable = x.Readable;
var Duplex = x.Duplex;
var Writable = x.Writable;
var PassThrough = x.PassThrough;
export {
  Duplex,
  PassThrough,
  Readable,
