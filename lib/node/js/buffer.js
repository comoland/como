...
import * as base64 from 'vendor/base64-js';
import * as ieee754 from 'vendor/ieee754';
...
function base64Slice__old(buf, start, end) {
...
function utf8Slice__old(buf, start, end) {
...
function asciiSlice__old(buf, start, end) {
    let ret = '';
    end = Math.min(buf.length, end);
...
function latin1Slice__old(buf, start, end) {
    let ret = '';
    end = Math.min(buf.length, end);
...
function hexSlice__old(buf, start, end) {
...
function utf16leSlice__old(buf, start, end) {
