...
import { validateNumber } from 'internal/validators';

const { BigInt, Float32Array, Float64Array, MathFloor, Number, Uint8Array, SymbolFor } = primordials;

const { ERR_BUFFER_OUT_OF_BOUNDS, ERR_INVALID_ARG_TYPE, ERR_OUT_OF_RANGE } = codes;
...
const untransferable_object_private_symbol = SymbolFor('COMOPrivate__symbol');
